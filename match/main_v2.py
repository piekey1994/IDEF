...
def cut_triples(line):
    ...
    for triple_str in line.split(sep2):
        ...
        #没有三元组的修正
        if len(triple_es)>3:
            triple_es=[' '.join(triple_es)]
            notriple+=1
        triples.append(triple_es)
    return triples


# args=[(0,250000),(250000,500000),(500000,750000),(750000,1000000)]
# args=[(1000000,1250000),(1250000,1500000),(1500000,1750000),(1750000,2000000)]
args=[(0,250000)]
for arg in args:
    print(arg)
    begin=arg[0]
    ...
    with open(q_file_path,'r',encoding='utf-8') as q_file,\
        ...
        for q_line,t_line in zip(q_file,t_file):
            ...
            score=eval_class.eval_v2(q_triples,t_triples)
